...
/*
QuoteApiService Create quote

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *QuoteApiCreateQuoteOpts - Optional Parameters:
     * @param "Body" (optional.Interface of QuoteCreateDto) -
...
func (a *QuoteApiService) CreateQuote(ctx context.Context, localVarOptionals *QuoteApiCreateQuoteOpts) (QuoteDto, *http.Response, error) {
	var (
		...
		localVarReturnValue QuoteDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api2/v1/quotes"
	...
	if localVarOptionals != nil && localVarOptionals.Body.IsSet() {
		...
		localVarOptionalBody, localVarOptionalBodyok := localVarOptionals.Body.Value().(QuoteCreateDto)
		if !localVarOptionalBodyok {
			return localVarReturnValue, nil, reportError("body should be QuoteCreateDto")
		}
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *QuoteApiCreateQuoteV2Opts - Optional Parameters:
     * @param "Body" (optional.Interface of QuoteCreateV2Dto) -
...
func (a *QuoteApiService) CreateQuoteV2(ctx context.Context, localVarOptionals *QuoteApiCreateQuoteV2Opts) (QuoteV2Dto, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue QuoteV2Dto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api2/v2/quotes"
	...
	if localVarOptionals != nil && localVarOptionals.Body.IsSet() {
		...
		localVarOptionalBody, localVarOptionalBodyok := localVarOptionals.Body.Value().(QuoteCreateV2Dto)
		if !localVarOptionalBodyok {
			return localVarReturnValue, nil, reportError("body should be QuoteCreateV2Dto")
		}
		localVarPostBody = &localVarOptionalBody
	}
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
...
func (a *QuoteApiService) DeleteQuote(ctx context.Context, quoteId int64) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api2/v1/quotes/{quoteId}"

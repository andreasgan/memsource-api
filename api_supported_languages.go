...
*/
func (a *SupportedLanguagesApiService) ListOfLanguages(ctx context.Context) (LanguageListDto, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue LanguageListDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api2/v1/languages"

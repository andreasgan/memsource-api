 ...
 * @param optional nil or *DomainApiCreateDomainOpts - Optional Parameters:
     * @param "Body" (optional.Interface of DomainEditDto) -
...
func (a *DomainApiService) CreateDomain(ctx context.Context, localVarOptionals *DomainApiCreateDomainOpts) (DomainDto, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/api2/v1/domains"
	...
	if localVarOptionals != nil && localVarOptionals.Body.IsSet() {
		...
		localVarOptionalBody, localVarOptionalBodyok := localVarOptionals.Body.Value().(DomainEditDto)
		if !localVarOptionalBodyok {
			return localVarReturnValue, nil, reportError("body should be DomainEditDto")
		}
...
func (a *DomainApiService) DeleteDomain(ctx context.Context, domainId int64) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api2/v1/domains/{domainId}"
...
/*
DomainApiService List of domains

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *DomainApiListDomainsOpts - Optional Parameters:
...
func (a *DomainApiService) ListDomains(ctx context.Context, localVarOptionals *DomainApiListDomainsOpts) (PageDtoDomainDto, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue PageDtoDomainDto
	)
...
/*
DomainApiService Edit domain

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param domainId
 * @param optional nil or *DomainApiUpdateDomainOpts - Optional Parameters:
     * @param "Body" (optional.Interface of DomainEditDto) -

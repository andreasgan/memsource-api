...
/*
MappingApiService Returns mapping for taskId (mxliff)

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *MappingApiGetMappingForTaskOpts - Optional Parameters:
...
func (a *MappingApiService) GetMappingForTask(ctx context.Context, id string, localVarOptionals *MappingApiGetMappingForTaskOpts) (TaskMappingDto, *http.Response, error) {
	var (
		...
		localVarReturnValue TaskMappingDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api2/v1/mappings/tasks/{id}"
